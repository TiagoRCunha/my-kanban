-- ─── V1: Baseline Schema ─────────────────────────────────────────────────────
-- Initial database schema for the Kanban board application.
-- Consolidates all CREATE TABLE and ALTER TABLE statements into a single baseline.
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    CONSTRAINT fk_tasks_tag FOREIGN KEY (tag_id) REFERENCES user_custom_tags(id) ON DELETE SET NULL,
